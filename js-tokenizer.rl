...
var states = exports.states = {
    ...
    AttributeValueDoubleQuoted: en_AttributeValueDoubleQuoted,
    AttributeValueSingleQuoted: en_AttributeValueSingleQuoted,
    ...
    DocType: en_DocType,
    BeforeDocTypeName: en_BeforeDocTypeName,
    DocTypeName: en_DocTypeName,
    AfterDocTypeName: en_AfterDocTypeName,
    AfterDocTypePublicKeyword: en_AfterDocTypePublicKeyword,
    BeforeDocTypePublicIdentifier: en_BeforeDocTypePublicIdentifier,
    DocTypePublicIdentifierDoubleQuoted: en_DocTypePublicIdentifierDoubleQuoted,
    DocTypePublicIdentifierSingleQuoted: en_DocTypePublicIdentifierSingleQuoted,
    AfterDocTypePublicIdentifier: en_AfterDocTypePublicIdentifier,
    BetweenDocTypePublicAndSystemIdentifiers: en_BetweenDocTypePublicAndSystemIdentifiers,
    AfterDocTypeSystemKeyword: en_AfterDocTypeSystemKeyword,
    BeforeDocTypeSystemIdentifier: en_BeforeDocTypeSystemIdentifier,
    DocTypeSystemIdentifierDoubleQuoted: en_DocTypeSystemIdentifierDoubleQuoted,
    DocTypeSystemIdentifierSingleQuoted: en_DocTypeSystemIdentifierSingleQuoted,
